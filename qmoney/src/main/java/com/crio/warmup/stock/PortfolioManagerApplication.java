...
public class PortfolioManagerApplication {
  ...
  public static List<String> mainReadFile(String[] args) throws IOException, URISyntaxException {
     File resultOfResolveFilePathArgs0 = resolveFileFromResources(args[0]);

     ObjectMapper objectMapper = getObjectMapper();
     PortfolioTrade[] t = objectMapper.readValue(resultOfResolveFilePathArgs0, PortfolioTrade[].class);
     List<String> symbols = new ArrayList<>();
     for(PortfolioTrade pf: t) {
  ...
  public static List<String> debugOutputs() {
     ...
     String resultOfResolveFilePathArgs0 = "/opt/criodo/qmoney/me_qmoney/qmoney/" + "build/resources/main/trades.json";
  ...
  private static List<TotalReturnsDto> mainReadQuotesHelper(String[] args, List<PortfolioTrade> trades) throws IOException, URISyntaxException {
    RestTemplate restTemplate = new RestTemplate();
    List<TotalReturnsDto> tests = new ArrayList<TotalReturnsDto>();
    for(PortfolioTrade t : trades) {
      String url = prepareUrl(t, LocalDate.parse(args[1]), "3c3b8db20bd3e85b8051a343cc639c78520ea71b");
  ...
  public static String getToken() {
    return "3c3b8db20bd3e85b8051a343cc639c78520ea71b";
  }
  ...
  public static List<Candle> fetchCandles(PortfolioTrade trade, LocalDate endDate, String token) {
    ...
    Candle[] candlesArray = restTemplate.getForObject(url, TiingoCandle[].class);
  ...
  public static List<AnnualizedReturn> mainCalculateSingleReturn(String[] args)
    ...
    PortfolioTrade[] portfolioTrade = getPortfolioTradeFromFile(args[0]);

    for(PortfolioTrade pt : portfolioTrade) {
      annualizedReturn.add(getAnnualizeReturn(pt, endDate));
    }

    // Sort in Descending Order 
    Comparator<AnnualizedReturn> SortByAnnReturn = Comparator.comparing(AnnualizedReturn::getAnnualizedReturn).reversed(); 
    Collections.sort(annualizedReturn, SortByAnnReturn);
  ...
  private static AnnualizedReturn getAnnualizeReturn(PortfolioTrade trade, LocalDate endDate) {
  ...
  private static PortfolioTrade[] getPortfolioTradeFromFile(String string) throws IOException, URISyntaxException {
    File resultOfResolveFilePathArgs0 = resolveFileFromResources(string);
